<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegularUserCredit.aspx.cs" Inherits="SSBank.RegularUserCredit" %>
...
<div id="wrapper">
    ...
    <div id="middle_sub" class="auto-style1">
        <div id="mid_title">Credit Account</div>
        <p class="auto-style5">&nbsp;Total Credit Line:</p>
        <p class="auto-style6">Available balance: </p>
        <p class="auto-style5">Credit Line Available:</p>
        <p>&nbsp;</p>
     ...
     <div id="main">
        ...
        <div class="col_w300 float_r">
            ...
            <h2>Account Information</h2>
             ...
             <p>Account Type: Credit Account</p>
            <p>Account Number:</p>
            <p>&nbsp;</p>
            <p>&nbsp;</p>
