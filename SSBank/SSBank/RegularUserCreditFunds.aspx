<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="RegularUserCreditFunds.aspx.cs" Inherits="SSBank.RegularUserCreditFunds" %>
...
<div id="wrapper">
    ...
    <div id="middle_sub" class="auto-style1">
        <div id="mid_title">Credit Funds</div>
        <p>&nbsp;</p>
     ...
     <div id="main">
        <div class="col_w600 float_l">
            ...
            <h2>Credit Funds from Account</h2>
            ...
            <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <asp:Button ID="Button1" runat="server" Text="Credit Funds!" />
            </p>
