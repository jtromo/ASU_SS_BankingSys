...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function loadAllowTabProfile() {
            var tabProfile = $get('<%=tab_EditProfile.ClientID%>');
            __doPostBack(tabProfile, '');
        }
</script>
    <div style="height:1250px";>
        <asp:ScriptManager ID="ScriptManager1" runat="server">
        </asp:ScriptManager>
        <asp:TabContainer ID="TabContainer1" runat="server" ActiveTabIndex="4" Width="945px" OnClientActiveTabChanged="LoadAllowBlock" OnActiveTabChanged="TabContainer1_ActiveTabChanged" Height="1250px">
                    ...
                    <asp:TabContainer ID="TabContainer7" runat="server" ActiveTabIndex="2" Width="917px" OnInit="deptTabInitialize" OnLoad="deptTabInitialize">
                        ...
                        <asp:TabPanel ID="tab_delemp" runat="server" HeaderText="Delete Employee">
                            <ContentTemplate>
                                ...
                                <br />
                                First Name:&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_FirstName_DelEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Middle Name:&nbsp;
                                <asp:TextBox ID="tb_MidName_DelEMp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Last Name:&nbsp;&nbsp;&nbsp; &nbsp;
                                <asp:TextBox ID="tb_LastName_DelEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Department:&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="DeptDD_DelEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="1">Unknown</asp:ListItem>
                                     <asp:ListItem Value="2">Sales</asp:ListItem>
                                     <asp:ListItem Value="3">IT Tech Support</asp:ListItem>
                                     <asp:ListItem Value="4">Transactions</asp:ListItem>
                                ...
                                <br />
                                Role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="RoleDD_DelEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="4">Regular Employee</asp:ListItem>
                                     <asp:ListItem Value="5">Department Manager</asp:ListItem>
                                ...
                                <br />
                                Email ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_Email_DelEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Contact:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_Phone_DelEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:TabPanel ID="tab_transemp" runat="server" HeaderText="Transfer Employee">
                            <ContentTemplate>
                                ...
                                <br />
                                First Name:&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_FName_TransEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Middle Name:&nbsp;
                                <asp:TextBox ID="tb_MName_TransEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Last Name:&nbsp;&nbsp;&nbsp; &nbsp;
                                <asp:TextBox ID="tb_LName_TransEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Department:&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="FROM_DeptDD_TransEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="1">Unknown</asp:ListItem>
                                     <asp:ListItem Value="2">Sales</asp:ListItem>
                                     <asp:ListItem Value="3">IT Tech Support</asp:ListItem>
                                     <asp:ListItem Value="4">Transactions</asp:ListItem>
                                ...
                                <br />
                                Role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="RoleDD_TransEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="4">Regular Employee</asp:ListItem>
                                     <asp:ListItem Value="5">Department Manager</asp:ListItem>
                                     <asp:ListItem Value="6">Company Official</asp:ListItem>
                                </asp:DropDownList>
                                <br />
                                Email ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_Email_TransEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Contact:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        ...
                        <asp:TabPanel ID="tab_viewemp" runat="server" HeaderText="View Employee Details">
                            <ContentTemplate>
                                ...
                                <br />
                                First Name:&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_FName_ViewEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Middle Name:&nbsp;
                                <asp:TextBox ID="tb_MName_ViewEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Last Name:&nbsp;&nbsp;&nbsp; &nbsp;
                                <asp:TextBox ID="tb_LName_ViewEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Department:&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="DeptDD_viewEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="1">Unknown</asp:ListItem>
                                     <asp:ListItem Value="2">Sales</asp:ListItem>
                                     <asp:ListItem Value="3">IT Tech Support</asp:ListItem>
                                     <asp:ListItem Value="4">Transactions</asp:ListItem>
                                ...
                                <br />
                                Role:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:DropDownList ID="RoleDD_ViewEmp" runat="server" Enabled="False">
                                    <asp:ListItem Value="4">Regular Employee</asp:ListItem>
                                     <asp:ListItem Value="5">Department Manager</asp:ListItem>
                                     <asp:ListItem Value="6">Company Official</asp:ListItem>
                                     <asp:ListItem Value="7">Admin</asp:ListItem>
                                ...
                                <br />
                                Email ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_Email_ViewEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                Contact:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                <asp:TextBox ID="tb_Phone_ViewEmp" runat="server" oncopy="return false" onpaste="return false" Enabled="False"></asp:TextBox>
                                <br />
                                <br />
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
            ...
            <asp:TabPanel ID="TabPanel1" runat="server" HeaderText="TabPanel1">
                ...
                <ContentTemplate>
                    ...
                    <p>
                        Email:
                        <asp:TextBox ID="tb_emailview_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                    </p>
                    <p>
                        Street Address:
                        <asp:TextBox ID="tb_streetAddress_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                        Username:
                        <asp:TextBox ID="tb_usernameview_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                    </p>
                    <p>
                        City:
                        <asp:TextBox ID="tb_city_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                        &nbsp;</p>
                    <p>
                        State:
                        <asp:DropDownList ID="StateDD_Profile_int" runat="server" Enabled="False">
                            <asp:ListItem Value="AL">Alabama</asp:ListItem>
                            <asp:ListItem Value="AK">Alaska</asp:ListItem>
                            <asp:ListItem Value="AZ">Arizona</asp:ListItem>
                            <asp:ListItem Value="AR">Arkansas</asp:ListItem>
                    ...
                    <p>
                        ZipCode:
                        <asp:TextBox ID="tb_ZipCode_Profile_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                    </p>
                    <p>
                        Contact:
                        <asp:TextBox ID="tb_contactview_int" runat="server" Enabled="False" oncopy="return false" onpaste="return false"></asp:TextBox>
                    </p>
                    <p>
                        <asp:Button ID="btnEditProfile_int" runat="server" OnClick="btnEditProfile_int_Click" style="height: 26px" Text="Edit Profile" />
                    </p>
                    <p>
                        <asp:TabContainer ID="tab_EditProfile" runat="server" ActiveTabIndex="0" Height="700px" OnActiveTabChanged="tab_EditProfile_ActiveTabChanged" OnClientActiveTabChanged="loadAllowTabProfile" Visible="False" Width="900px">
                            <asp:TabPanel ID="tabeditprofile0" runat="server" HeaderText="Edit Profile" Height="600px" Width="124px">
                                <ContentTemplate>
                                    <br />
                                    <h6>Contact Information</h6>
                                    <p>
                                        Email Address:
                                        <asp:TextBox ID="tb_emailedit_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        Street Address:
                                        <asp:TextBox ID="tb_addr_editprofile_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                        City:
                                        <asp:TextBox ID="tb_city_editProfile_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        State:
                                        <asp:DropDownList ID="StateDD_EditProfile_int" runat="server">
                                            <asp:ListItem Value="AL">Alabama</asp:ListItem>
                                            <asp:ListItem Value="AK">Alaska</asp:ListItem>
                                            <asp:ListItem Value="AZ">Arizona</asp:ListItem>
                                            <asp:ListItem Value="AR">Arkansas</asp:ListItem>
                                        ...
                                        Zip:
                                        <asp:TextBox ID="tb_zip_editProfile_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        Contact:
                                        <asp:TextBox ID="tb_contactedit_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        <asp:Label ID="lblChaneProfile_int" runat="server" Visible="False"></asp:Label>
                                    </p>
                                    <p>
                                        <asp:Button ID="btn_changesettings_profile_int" runat="server" OnClick="btn_changesettings_profile_int_Click" Text="Edit Contact Info" />
                                    </p>
                                    <p>
                                        &nbsp;</p>
                                </ContentTemplate>
                            </asp:TabPanel>
                            <asp:TabPanel ID="tabchangepwd0" runat="server" HeaderText="Change Password" Height="680px" TabIndex="1" Width="124px">
                                <HeaderTemplate>
                                    Change Password
                                </HeaderTemplate>
                                <ContentTemplate>
                                    ...
                                    <p>
                                        Old Password:
                                        <asp:TextBox ID="tb_oldpwd_int" runat="server" oncopy="return false" onpaste="return false" TextMode="Password"></asp:TextBox>
                                    </p>
                                    <p>
                                        New Password:
                                        <asp:TextBox ID="tb_newPass_int" runat="server" Height="16px" oncopy="return false" onpaste="return false" TextMode="Password"></asp:TextBox>
                                        <asp:PasswordStrength ID="tb_newPass_int_PasswordStrength" runat="server" Enabled="True" MinimumLowerCaseCharacters="1" MinimumNumericCharacters="1" MinimumSymbolCharacters="1" MinimumUpperCaseCharacters="1" PreferredPasswordLength="12" RequiresUpperAndLowerCaseCharacters="True" StrengthStyles="TextIndicator_TB_Password_Strength1;TextIndicator_TB_Password_Strength2;TextIndicator_TB_Password_Strength3;TextIndicator_TB_Password_Strength4;TextIndicator_TB_Password_Strength5" TargetControlID="tb_newPass_int" TextStrengthDescriptions="Very Weak;Weak;Average;Strong;Very Strong" TextStrengthDescriptionStyles="TextIndicator_TB_Password_Strength1;TextIndicator_TB_Password_Strength2;TextIndicator_TB_Password_Strength3;TextIndicator_TB_Password_Strength4;TextIndicator_TB_Password_Strength5">
                                        </asp:PasswordStrength>
                                        Confirm Password:
                                        <asp:TextBox ID="tb_confrimPass_int" runat="server" oncopy="return false" onpaste="return false" TextMode="Password"></asp:TextBox>
                                        <asp:PasswordStrength ID="tb_confrimPass_int_PasswordStrength" runat="server" Enabled="True" MinimumLowerCaseCharacters="1" MinimumNumericCharacters="1" MinimumSymbolCharacters="1" MinimumUpperCaseCharacters="1" PreferredPasswordLength="12" StrengthStyles="TextIndicator_TB_Password_Strength1;TextIndicator_TB_Password_Strength2;TextIndicator_TB_Password_Strength3;TextIndicator_TB_Password_Strength4;TextIndicator_TB_Password_Strength5" TargetControlID="tb_confrimPass_int" TextStrengthDescriptions="Very Weak;Weak;Average;Strong;Very Strong" TextStrengthDescriptionStyles="TextIndicator_TB_Password_Strength1;TextIndicator_TB_Password_Strength2;TextIndicator_TB_Password_Strength3;TextIndicator_TB_Password_Strength4;TextIndicator_TB_Password_Strength5">
                                        </asp:PasswordStrength>
                                    </p>
                                    <p>
                                        Sequrity Question 1:
                                        <asp:DropDownList ID="dd_secque1_int" runat="server" Enabled="False" EnableTheming="True">
                                            <asp:ListItem Value="Default Question">Select Security Question</asp:ListItem>
                                            <asp:ListItem Value="1">What was your childhood nickname? </asp:ListItem>
                                            <asp:ListItem Value="2">In what city did you meet your spouse/significant other?</asp:ListItem>
                                            <asp:ListItem Value="3">What is the name of your favorite childhood friend? </asp:ListItem>
                                    ...
                                    <p>
                                        Answer:
                                        <asp:TextBox ID="tb_secans_int1" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        Security Question 2:
                                        <asp:DropDownList ID="dd_secque2_int" runat="server" Enabled="False">
                                            <asp:ListItem Value="Default Question">Select Security Question</asp:ListItem>
                                            <asp:ListItem Value="1">What was your childhood nickname? </asp:ListItem>
                                            <asp:ListItem Value="2">In what city did you meet your spouse/significant other?</asp:ListItem>
                                            <asp:ListItem Value="3">What is the name of your favorite childhood friend? </asp:ListItem>
                                    ...
                                    <p>
                                        Answer:
                                        <asp:TextBox ID="tb_secans_int2" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    </p>
                                    <p>
                                        Security Question 3:
                                        <asp:DropDownList ID="dd_secque3_int" runat="server" Enabled="False">
                                            <asp:ListItem Value="Default Question">Select Security Question</asp:ListItem>
                                            <asp:ListItem Value="1">What was your childhood nickname? </asp:ListItem>
                                            <asp:ListItem Value="2">In what city did you meet your spouse/significant other?</asp:ListItem>
                                            <asp:ListItem Value="3">What is the name of your favorite childhood friend? </asp:ListItem>
                                    ...
                                    <p>
                                        Answer:
                                        <asp:TextBox ID="tb_secans_int3" runat="server" Height="16px" oncopy="return false" onpaste="return false" Width="128px"></asp:TextBox>
                                        <asp:Label ID="lblStatus_ChgPwd_int" runat="server" Visible="False"></asp:Label>
                                    </p>
                                    <p>
                                        <asp:Button ID="btn_changepwd_int" runat="server" CssClass="auto-style3" OnClick="btn_changepwd_int_Click" Text="Change Password" />
                                    </p>
                                    <p>
                                    </p>
                                </ContentTemplate>
                            ...
                            <asp:TabPanel ID="TabPanel2" runat="server" HeaderText="TabPanel2">
                                ...
                                <ContentTemplate>
                                    <br />
                                    Security Question 1:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:DropDownList ID="Sec1DD_PersonalInformation_int" runat="server">
                                    ...
                                    <br />
                                    Answer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="tb_SecAns1_Cust_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    <br />
                                    Security Question 2:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:DropDownList ID="Sec2DD_PersonalInformation_int" runat="server">
                                        <asp:ListItem Value="1">What was your childhood nickname? </asp:ListItem>
                                    ...
                                    <br />
                                    Answer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="tb_SecAns2_Cust_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    <br />
                                    Security Question 3:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:DropDownList ID="Sec3DD_PersonalInformation_int" runat="server">
                                        <asp:ListItem Value="1">What was your childhood nickname? </asp:ListItem>
                                        <asp:ListItem Value="2">In what city did you meet your spouse/significant other?</asp:ListItem>
                                    ...
                                    <br />
                                    Answer:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="tb_SecAns3_Cust_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    <br />
                                    Social Security Number:&nbsp;
                                    <asp:TextBox ID="tb_SSN_Cust_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    <br />
                                    <br />
                                    SiteKey:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int1" runat="server" OnClick="img_site_int1_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int2" runat="server" OnClick="img_site_int2_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int3" runat="server" OnClick="img_site_int3_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int4" runat="server" OnClick="img_site_int4_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int5" runat="server" OnClick="img_site_int5_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int6" runat="server" OnClick="img_site_int6_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int7" runat="server" OnClick="img_site_int7_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int8" runat="server" OnClick="img_site_int8_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int9" runat="server" OnClick="img_site_int9_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int10" runat="server" OnClick="img_site_int10_Click" />
                                    &nbsp;<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
                                    <asp:ImageButton ID="img_site_int11" runat="server" OnClick="img_site_int11_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int12" runat="server" OnClick="img_site_int12_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int13" runat="server" OnClick="img_site_int13_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int14" runat="server" OnClick="img_site_int14_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int15" runat="server" OnClick="img_site_int15_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int16" runat="server" OnClick="img_site_int16_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int17" runat="server" OnClick="img_site_int17_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int18" runat="server" OnClick="img_site_int18_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int19" runat="server" OnClick="img_site_int19_Click" />
                                    &nbsp;&nbsp;
                                    <asp:ImageButton ID="img_site_int20" runat="server" OnClick="img_site_int20_Click" />
                                    &nbsp;<br />Sitekey Hint:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:TextBox ID="tb_sitekeyhint_Cust_int" runat="server" oncopy="return false" onpaste="return false"></asp:TextBox>
                                    <br />
                                    <br />
                                    <asp:Label ID="lblStatus_SiteKey_int" runat="server" Visible="False"></asp:Label>
                                    <br />
                                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                    <asp:Button ID="btnSetSiteKey_int" runat="server" OnClick="btnSetSiteKey_int_Click" Text="Set Password Recovery" />
                                </ContentTemplate>
                            </asp:TabPanel>
                        </asp:TabContainer>
                        <p>
